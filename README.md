...
data as well. (N.B: Just Get familirity with theses steps, proably u wont be able to complete since its need advance API)
...
6. Draw on the same plot the degree distribution of fake news and real news.
